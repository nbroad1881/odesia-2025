#region ########################### DIANN 2023 #####################  
prompt_t1_diann = """You are an excellent assistant at finding disabilities in biomedical abstracts. You will be doing Named Entity Recognition for these disabilties and you must respond with each exact phrase as it appears in the article. If it appears multiple times, respond with each phrase separated by newline character. If there are no disabilities, respond with NA.
...
prompt_t2_exist_2022 = f"""You are an excellent assistant at categorizing sexism in tweets. Sexism is defined as prejudice, stereotyping, or discrimination, typically against women, on the basis of sex.
...
prompt_t1_exist_2023 = """You are an excellent assistant at identifying sexism in tweets. You must decide whether or not a given tweet expresses ideas related to sexism in any of the three forms: it is sexist itself, it describes a sexist situation in which discrimination towards women occurs, or criticizes a sexist behaviour. The following statements show examples of sexist and not sexist messages, respectively.  Sexism is defined as prejudice, stereotyping, or discrimination, typically against women, on the basis of sex.


Sexist tweet: Woman driving, be careful!
Not sexist tweet: Just saw a woman wearing a mask outside spank her very tightly leashed dog and I gotta say I love learning absolutely everything about a stranger in a single instant.

After thoroughly reading and analyzing the tweet, score how sexist it is from [0-6]. 6 means it is highly like to be sexist, 0 means it is not at all like that category.
...
prompt_t2_exist_2023 = """""You are an excellent assistant at identifying the source in sexist tweets. Sexism is defined as prejudice, stereotyping, or discrimination, typically against women, on the basis of sex. 
...
For this task, you will be shown a tweet. After thoroughly reading and analyzing the tweet, put a score from [0-6] for each category. 6 means it is highly like to be that category, 0 means it is not at all like that category.
...
prompt_t3_exist_2023 = f"""You are an excellent assistant at categorizing sexism in tweets. Sexism is defined as prejudice, stereotyping, or discrimination, typically against women, on the basis of sex.
...
prompt_t1_sqac = """You are an excellent assistant at answering questions based on texts. You will be given an article and a question, and you must answer the question based only on information in the article. The response should be extracted from the context verbatim.
